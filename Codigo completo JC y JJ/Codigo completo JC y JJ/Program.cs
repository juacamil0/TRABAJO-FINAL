namespace Codigo_completo_JC_y_JJ
{
    internal class Program
    {
        ...
        static void MenuVehiculos()
        {
            ...
            while (opcion != 5)
            {
                ...
                else if (opcion == 4) ModificarVehiculo();
            }
        }
        ...
        //Modificar vehículo JCE
        static void ModificarVehiculo()
        {
            Console.Write("Placa del vehículo a modificar: ");
            string placa = Console.ReadLine();
        ...
        static void MenuClientes()
        {
            ...
            while (opcion != 4)
            {
                ...
                else if (opcion == 3) ModificarCliente();
            }
        }
        ...
        //Modificar clientes JJ y JCE
        static void ModificarCliente()
        {
            Console.Write("Cédula del cliente a modificar: ");
            string ced = Console.ReadLine();
            ...
            for (int i = 0; i < clientesRegistrados; i++)
            {
                if (cedulas[i] == ced)
                {
                    Console.WriteLine($"Nombre actual: {nombres[i]}");
